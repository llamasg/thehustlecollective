...
const brandColors = [
  { bg: "bg-blue", text: "text-white", hex: "#174af4" },
  { bg: "bg-blue", text: "text-white", hex: "#174af4" },
  { bg: "bg-blue", text: "text-white", hex: "#174af4" },
  { bg: "bg-grey", text: "text-black", hex: "#f5f0e8" },
];
  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        {/* ── Hero ── */}
        <section className="relative bg-black pt-32 pb-20 md:pt-44 md:pb-32">
          {/* Decorative background asterisks */}
          <div
            className="pointer-events-none absolute inset-0 select-none overflow-hidden"
            aria-hidden="true"
          >
            <span className="absolute top-20 right-[15%] text-[12rem] leading-none text-blue opacity-[0.06]">
              ✱
            </span>
            <span className="absolute bottom-10 left-[8%] text-[8rem] leading-none text-blue opacity-[0.08]">
              ✱
            </span>
          </div>
          ...
          <div className="relative mx-auto max-w-[1500px] px-6 md:px-12 lg:px-20">
            ...
            >
              <span className="mb-6 block text-blue">
                ✱ The People
              </span>
            </motion.div>

            <motion.h1
              className="text-display text-[clamp(3rem,10vw,9rem)] text-white"
            ...
            <motion.p
              className="text-editorial mt-8 max-w-xl text-lg text-white/60 md:text-xl"
          ...
          {/* Angled bottom edge */}
          <div className="absolute bottom-0 left-0 right-0 h-16 bg-grey [clip-path:polygon(0_100%,100%_0,100%_100%)]" />
        </section>

        {/* ── Team Grid — editorial stagger ── */}
        <section className="relative bg-grey py-20 md:py-32">
          {/* Section label */}
          <div className="mx-auto max-w-[1500px] px-6 md:px-12 lg:px-20">
            ...
            >
              <span className="text-black/40">The Collective</span>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                        ...
                        <span
                          className={`${color.text} text-sm tracking-wide uppercase opacity-40`}
                        >
                          {member.name}
                        </span>
                        <span
        ...
        <section className="relative bg-black py-20 md:py-32">
          {/* Decorative element */}
          <div
            className="pointer-events-none absolute top-12 left-[5%] select-none text-blue opacity-[0.06] hidden lg:block"
            aria-hidden="true"
            style={{
          ...
          <div className="relative mx-auto max-w-[1500px] px-6 md:px-12 lg:px-20">
            ...
            >
              <span className="text-sm tracking-wide uppercase mb-4 block text-blue">
                ✱ Festival Directors
              </span>
              ...
              <p className="text-editorial mt-6 max-w-md text-white/50 text-base md:text-lg">
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                          ...
                          <span className={`${color.text} text-sm tracking-wide uppercase opacity-40`}>
                      ...
                      <div className="flex flex-col justify-center">
                        <p className="text-sm tracking-wide uppercase mb-3 text-blue">
                          {director.festival}
                        </p>
                        ...
                        <span
                          className="mt-4 text-blue text-xl"
                          aria-hidden="true"
                        >
                          ✱
                        </span>
        ...
        <section className="relative bg-grey py-20 md:py-32">
          <div className="mx-auto max-w-[1500px] px-6 text-center md:px-12 lg:px-20">
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <span className="text-blue text-4xl" aria-hidden="true">
                ✱
              </span>
              <h2 className="text-display mt-4 text-[clamp(2rem,6vw,5rem)] text-black">
                WANT TO BE
                <br />
                PART OF IT?
              </h2>
              <p className="text-editorial mx-auto mt-6 max-w-lg text-black/60 text-base md:text-lg">
              ...
              <a
                href="/contact"
                className="mt-10 inline-block rounded-sm bg-black px-10 py-4 text-sm font-bold uppercase tracking-wider text-white transition-colors duration-300 hover:bg-blue"
              >
                Get In Touch
              </a>
            </motion.div>
